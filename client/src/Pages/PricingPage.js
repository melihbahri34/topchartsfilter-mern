...
// pricing cards
import PricingCardWhite from '../Components/PricingCardWhite';
import PricingCardBlack from '../Components/PricingCardBlack';
...
export default class PricingPage extends Component {
  render() {
    ...
    const dataCard = [
      {"Name": "Free", "Price": "$0", "Button":"Sign up for free", items: dataItems[0], "color":"white"}, 
      {"Name":"Premium", "Price": "$49", "Button":"Get started", items: dataItems[1], "color":"white"}, 
      {"Name":"Pro", "Price":"$500", "Button":"Get started", items: dataItems[2], "color":"black"}, 
      {"Name":"Enterprise", "Price":"$999", "Button":"Get started", items: dataItems[3], "color":"white"}];
