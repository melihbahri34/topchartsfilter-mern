    ...
    return (   
        <div class="pt-16">
            <div class="w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                ...
                <p class="mt-8 text-xs font-light text-center text-gray-400"> Do you have an account? 
                    <a href={ROUTES.LOGIN} class="font-medium text-gray-700 dark:text-gray-200 hover:underline"> Login</a>
                </p>
            </div>
            <div class="pt-32"/>
        </div>
